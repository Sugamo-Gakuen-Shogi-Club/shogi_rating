...
import { ArrowUp, Star, TrendingUp, Users, Calendar, Award, Medal } from 'lucide-react';
...
const RankBadge: React.FC<{ ranks: RankEntry[] }> = ({ ranks }) => {
  ...
  return (
    <div className="flex flex-wrap gap-1 mt-1">
      {ranks.map(r => (
        <span key={r.id}
          className="text-[9px] px-1.5 py-0.5 bg-purple-900/30 text-purple-300 border border-purple-700/40 rounded font-black tracking-tight"
